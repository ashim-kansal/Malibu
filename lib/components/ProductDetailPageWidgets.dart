...
class ProductDetailsWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _ProductDetailsWidget();
  }
}

class _ProductDetailsWidget extends State<ProductDetailsWidget> {
  int count = 0;
                  ...
                  children: [
                    ...
                    Flexible(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pushNamed(context, SelectOptionDialog.RouteName);
